...
import com.app.mygrocery.Activities.DetailsActivity;
...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
   private Context context;
    ...
    public void onBindViewHolder(RecyclerViewAdapter.ViewHolder holder, int position) {
        ...
        holder.quantity.setText("Quantity   : "+grocery.getQuantity());
        holder.dateAdded.setText("Date  : "+ df.format("yyyy-MM-dd",grocery.getDateItemAdded().toDate()));
        ...
        public ViewHolder(View view, Context ctx) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("date", df.format("yyyy-MM-dd",grocery.getDateItemAdded().toDate()));
